...
})({"di9k8":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "c3cc6cf9714af2d8";
"use strict";
...
parcelHelpers.export(exports, "chargerPage", ()=>chargerPage);
/**
...
function chargerPage(url, containerId) {
    return new Promise((resolve, reject)=>{
        ...
        xhr.onreadystatechange = function() {
            if (xhr.readyState === 4) {
                if (xhr.status === 200) {
                    ...
                    } else reject(new Error(`Element with ID '${containerId}' not found`));
                } else reject(new Error(`HTTP ${xhr.status}: Failed to load ${url}`));
            }
        };
