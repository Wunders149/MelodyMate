...
})({"emmWk":[function(require,module,exports,__globalThis) {
module.exports = require("1e4c892b9f763b2e")(module.bundle.resolve("karaoke-data.4457fe3a.js")).catch((err)=>{
    delete module.bundle.cache[module.id];
    throw err;
}).then(()=>module.bundle.root('hqufr'));

},{"1e4c892b9f763b2e":"61B45","hqufr":"hqufr"}],"61B45":[function(require,module,exports,__globalThis) {
"use strict";
...
document.addEventListener('DOMContentLoaded', async function() {
    // Import the API
    const { karaokeAPI, demoSongs } = await parcelRequireb585("emmWk");
...
//# sourceMappingURL=search.febd1ee4.js.map
